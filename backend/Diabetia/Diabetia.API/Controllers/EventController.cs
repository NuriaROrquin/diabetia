...
namespace Diabetia.API.Controllers
{
    ...
    public class EventController : ControllerBase
    {
        ...
        {
            await _eventGlucosetUseCase.AddGlucoseEvent(request.Email, request.IdKindEvent, request.EventDate, request.FreeNote, request.Glucose.Value, request.IdFoodEvent, request.PostFoodMedition);
            return Ok();
        }
