...
const FoodDishesPage = () => {
    const { saveFile } = useAIDataDishes();
    ...
    const tomarFoto = () => {
        ...
        apagarCamara();
        router.push("/food/foodDishes/step-1");
    };
        ...
        <Section className="">
            <div className="bg-blue-primary w-full h-screen bg-opacity-70 flex flex-col items-center gap-12">
                <div>
                    ...
                    <SubtitleSection className="text-white">Subí la imagen de tu plato</SubtitleSection>
                </div>
