...
import {
    FILTERS,
    initialAreaChartOptions,
    initialMultipleChartOptions,
    initialPieChartOptions,
...
export const ChartLineComponent = props => {
    ...
    return (
        <>
            <div data-testId="headerChart"
                 className="flex flex-col lg:flex-row flex-wrap justify-center place-content-center items-center lg:justify-between px-8 py-4 gap-y-2">
        ...
        const fetchData = async () => {
            try {
                ...
                const {
                    dateFrom,
                    dateTo
                } = calculateDateRange(titlesArray.find(title => filterSelected && title === filterSelected.title));
...
export const ChartPieComponent = props => {
    ...
    const [loading, setLoading] = useState(true);
    const [filterSelected, setFilterSelected] = useState(FILTERS[3]);
    const [option, setOption] = useState(initialPieChartOptions);
        ...
        const fetchData = async () => {
            try {
                ...
                const updateOption = {
                    ...
                    series: [
                        {
                            ...initialPieChartOptions.series[0],
                            data: response.data
                        }
                    ]
                };
...
export const ChartAreaComponent = props => {
    ...
    const [loading, setLoading] = useState(true);
    const [filterSelected, setFilterSelected] = useState(FILTERS[3]);
    const [option, setOption] = useState(initialAreaChartOptions);
        ...
        const fetchData = async () => {
            try {
                ...
                const updateOption = {
                    ...initialAreaChartOptions,
                    xAxis: {
                        ...initialAreaChartOptions.xAxis,
                        data: xAxisData
                    },
                    series: [
                        {
                            ...initialAreaChartOptions.series[0],
                            data: seriesData
                        }
                    ]
                };
